...
class ActivityListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final activities = List.generate(10, (i) => {
      'title': 'Mia Castro posted new activity: ACTIVITY ${10 - i}',
      'date': 'July ${28 - i * 2}',
    });
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Chose Activity', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
        centerTitle: true,
      ),
        backgroundColor: Colors.white,
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(a['title']!, style: const TextStyle(fontWeight: FontWeight.w500, fontSize: 15)),
