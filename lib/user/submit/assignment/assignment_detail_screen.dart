    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text('ASSIGNMENT 10- My Role in Nation-Building', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 22)),
            ...
            Row(
              ...
              children: const [
                ...
                Expanded(child: Text('Assignment: Write a short essay or reflection about how you, as a student, can contribute to the development of your community and country.', style: TextStyle(fontSize: 15))),
              ],
            ),
            const SizedBox(height: 16),
            Row(
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          const Expanded(
                            child: Text('Assignment-10-My Role in Nation-Building.docx', maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(fontWeight: FontWeight.w500)),
                          ),
                          const SizedBox(width: 10),
                          GestureDetector(
                            onTap: () {
