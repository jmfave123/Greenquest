...
class WebActivityListScreen extends StatefulWidget {
  ...
  @override
  State<WebActivityListScreen> createState() => _WebActivityListScreenState();
}

class _WebActivityListScreenState extends State<WebActivityListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer:
          !isDesktop
              ? Drawer(child: WebSidebar(currentRoute: WebRoutes.activities))
              : null,
      body: Row(
        children: [
          if (isDesktop) const WebSidebar(currentRoute: WebRoutes.activities),
          Expanded(
            child: Container(
    ...
    return Column(
      ...
      children: [
        Row(
          ...
          children: [
            const Text('Your Activities', style: WebTheme.headingLarge),
            IconButton(
        ...
        Obx(
          () => Text(
            controller.currentInstructorUid.value.isNotEmpty
                ? 'Showing activities from ${controller.currentInstructorName.value}'
                : 'All activities across your courses',
  ...
  Widget _buildActivityCard(Map<String, dynamic> activity) {
    ...
    final status = controller.submissionStatus[activityId] ?? 'not_submitted';
    ...
    return MouseRegion(
      ...
      child: GestureDetector(
        onTap: () {
          ...
          Get.to(() => WebActivityDetailScreen(activity: activity));
        },
        child: Container(
            ...
            children: [
              Row(
                children: [
                  ...
                  const Spacer(),
                  _buildStatusBadge(status, activity['dueDate']),
                ],
              ),
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Due: ${controller.getDueDateFormatted(activity['dueDate'])}',
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 24),
            const Text('No activities found', style: WebTheme.headingMedium),
            const SizedBox(height: 8),
            Text(
              'Your activities will appear here once assigned by your instructor.',
...
extension on ActivityController {
