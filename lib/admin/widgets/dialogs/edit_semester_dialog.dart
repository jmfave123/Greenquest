...
/// Dialog for editing an existing semester
class EditSemesterDialog extends StatefulWidget {
  final Map<String, dynamic> semesterData;
  final Function(String year, String semester) onUpdate;
...
class _EditSemesterDialogState extends State<EditSemesterDialog> {
  ...
  void initState() {
    ...
    yearController = TextEditingController(
      text: widget.semesterData['year'] ?? '',
    );
    selectedSemester = widget.semesterData['semester'] ?? '1st Semester';
  }
