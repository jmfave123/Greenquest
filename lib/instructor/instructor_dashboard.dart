...
class _InstructorDashboardScreenState extends State<InstructorDashboardScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Row(
        children: [
          InstructorSidebar(selectedIndex: _sidebarIndex, onItemSelected: (idx) {
...
class _StatCard extends StatelessWidget {
  ...
  final Color iconBg;
  const _StatCard({required this.image, required this.label, required this.value, required this.borderColor, required this.iconBg});
        ...
        child: Row(
          ...
          children: [
            ...
            Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                Text(label, style: const TextStyle(color: Colors.black38, fontWeight: FontWeight.bold, fontSize: 15)),
                const SizedBox(height: 6),
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              const Text('Student  Progress', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
              Row(
                children: [
                  IconButton(
                    icon: const Icon(Icons.chevron_left, size: 22, color: Colors.black38),
                    onPressed: () => _changeMonth(-1),
                  ),
                  Text(months[selectedMonth], style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 15, color: Colors.black54)),
                  IconButton(
                    icon: const Icon(Icons.chevron_right, size: 22, color: Colors.black38),
                    onPressed: () => _changeMonth(1),
                  ),
                  ...
                  Text('$selectedYear', style: const TextStyle(color: Color(0xFF22C55E), fontWeight: FontWeight.bold, fontSize: 14)),
                ],
              ),
            ],
          ),
          ...
          SizedBox(
            ...
            child: CustomPaint(
              painter: _BarLineChartPainter(bars: bars, line: line, labels: labels),
            ),
          ),
        ],
      ),
...
class _BarLineChartPainter extends CustomPainter {
  ...
  _BarLineChartPainter({required this.bars, required this.line, required this.labels});
      ...
      child: Column(
        ...
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              const Text('Leaderboard\nTop 10', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
              Row(
                children: [
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, i) {
                  ...
                  if (isTop) {
                    ...
                    if (i == 0) {
                      leading = Image.asset('assets/instructor/icons/stash_trophy-light.png', width: 30, height: 30);
                    } else if (i == 1) {
                      leading = Image.asset('assets/instructor/icons/stash_trophy-light.png', width: 30, height: 30, color: const Color(0xFFB6BBC4));
                    } else {
                      leading = Image.asset('assets/instructor/icons/stash_trophy-light.png', width: 30, height: 30, color: Color(0xFFCD7F32));
                    }
                  } else {
                    bgColor = const Color(0xFFF8FAFB);
                    borderColor = Colors.transparent;
                    nameColor = const Color(0xFFB6BBC4);
                    leading = Text('#${i + 1}', style: const TextStyle(fontWeight: FontWeight.bold, color: Color(0xFFB6BBC4), fontSize: 18));
                  }
                  return Container(
                        ...
                        Expanded(
                          child: isPlaceholder
                              ...
                              : Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text(name, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: nameColor)),
                                    Text(className, style: const TextStyle(color: Colors.black38, fontSize: 13)),
                                  ],
                                ),
                        ),
                        if (!isPlaceholder)
                          Container(
                            ...
                            child: Text('$points pts', style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.white, fontSize: 12)),
                          ),
                      ],
                    ),
                  );
