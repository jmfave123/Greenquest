...
class InstructorMessageScreen extends StatefulWidget {
  ...
  const InstructorMessageScreen({Key? key, required this.student}) : super(key: key);

  @override
  State<InstructorMessageScreen> createState() => _InstructorMessageScreenState();
}
...
class _InstructorMessageScreenState extends State<InstructorMessageScreen> {
  ...
  final List<Map<String, dynamic>> messages = [
    {
      'from': 'student',
      'text': 'Hi Ms. Thompson, I have a question about the homework assignment.',
      'time': '10:30 AM',
    },
    {
      'from': 'instructor',
    ...
    {
      'from': 'student',
      'text': 'I\'m stuck on problem 15. I don\'t understand how to solve for x when there are two variables.',
      'time': '10:36 AM',
    },
    {
      'from': 'instructor',
      'text': 'Great question! When you have two variables, you need to use substitution or elimination method. Let me walk you through it step by step.',
      'time': '10:37 AM',
    },
  ];
  ...
  void _onSidebarSelect(int idx) {
    ...
    if (idx == 0) {
      ...
      Get.offAllNamed('/instructor-message-list');
    }
  }
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      Text(student['status'], style: TextStyle(color: student['online'] ? const Color(0xFF22C55E) : Colors.black38, fontSize: 14)),
                                      if (student['online'])
                                        Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            msg['time'],
                                            style: TextStyle(
                                              color: isMe ? const Color(0xFF22C55E) : Colors.black38,
                                              fontSize: 12,
                                            ),
                                          ),
                                        ],
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              IconButton(
                                icon:Image.asset('assets/icons/Vector (8).png', width: 22, color: Color(0xFFBDBDBD)),
                                onPressed: () {},
                              ),
                              IconButton(
                                icon: Image.asset('assets/icons/akar-icons_send.png', width: 22, color: const Color(0xFF22C55E)),
                                onPressed: () {},
                              ),
                            ],
                          ),
